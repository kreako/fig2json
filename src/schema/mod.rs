...
pub use transformations::{
    ...
    remove_default_visible, remove_derived_text_layout_size, remove_document_properties,
    remove_edit_info_fields, remove_empty_derived_text_data, remove_empty_font_postscript,
    ...
    remove_root_blobs, remove_root_metadata, remove_stroke_properties, remove_text_data_fields,
    remove_text_glyphs, remove_text_layout_fields, remove_text_metadata_fields, simplify_enums,
